...
T = {
    "en": {
        ...
        "mode_label": "What do you want to create?",
        "mode_text": "Product description",
        "mode_card": "Product photo card",
        "card_header": "Product photo card",
        "card_hint": "Upload a product photo — we remove the background and place the product on a clean, marketplace-ready background. The product itself is never altered.",
        "card_upload": "Upload a product photo",
        "card_bg": "Background",
        "card_generate": "Create photo card",
        "card_need": "Upload a product photo first.",
        "card_spinner": "Removing background and building your card...",
        "card_done": "Your photo card is ready — download below.",
        "card_download": "Download image",
        "card_bgs": {"White": "White", "Light studio": "Light studio", "Soft grey": "Soft grey", "Warm beige": "Warm beige", "Gradient blue": "Gradient blue"},
    ...
    "ru": {
        ...
        "mode_label": "Что вы хотите создать?",
        "mode_text": "Описание товара",
        "mode_card": "Фото-карточка товара",
        "card_header": "Фото-карточка товара",
        "card_hint": "Загрузите фото товара — мы уберём фон и поставим товар на чистый фон, готовый для маркетплейса. Сам товар не изменяется.",
        "card_upload": "Загрузите фото товара",
        "card_bg": "Фон",
        "card_generate": "Создать карточку",
        "card_need": "Сначала загрузите фото товара.",
        "card_spinner": "Убираю фон и собираю карточку...",
        "card_done": "Карточка готова — скачайте ниже.",
        "card_download": "Скачать изображение",
        "card_bgs": {"White": "Белый", "Light studio": "Светлая студия", "Soft grey": "Мягкий серый", "Warm beige": "Тёплый беж", "Gradient blue": "Синий градиент"},
    ...
    "es": {
        ...
        "mode_label": "¿Qué quieres crear?",
        "mode_text": "Descripción del producto",
        "mode_card": "Ficha con foto del producto",
        "card_header": "Ficha con foto del producto",
        "card_hint": "Sube una foto del producto — quitamos el fondo y colocamos el producto sobre un fondo limpio, listo para marketplace. El producto no se altera.",
        "card_upload": "Sube una foto del producto",
        "card_bg": "Fondo",
        "card_generate": "Crear ficha con foto",
        "card_need": "Primero sube una foto del producto.",
        "card_spinner": "Quitando el fondo y creando tu ficha...",
        "card_done": "Tu ficha está lista — descárgala abajo.",
        "card_download": "Descargar imagen",
        "card_bgs": {"White": "Blanco", "Light studio": "Estudio claro", "Soft grey": "Gris suave", "Warm beige": "Beige cálido", "Gradient blue": "Azul degradado"},
    ...
    "fr": {
        ...
        "mode_label": "Que voulez-vous créer ?",
        "mode_text": "Description produit",
        "mode_card": "Fiche photo produit",
        "card_header": "Fiche photo produit",
        "card_hint": "Importez une photo du produit — nous retirons l'arrière-plan et plaçons le produit sur un fond propre, prêt pour les marketplaces. Le produit n'est jamais modifié.",
        "card_upload": "Importez une photo du produit",
        "card_bg": "Arrière-plan",
        "card_generate": "Créer la fiche photo",
        "card_need": "Importez d'abord une photo du produit.",
        "card_spinner": "Suppression de l'arrière-plan et création de votre fiche...",
        "card_done": "Votre fiche est prête — téléchargez ci-dessous.",
        "card_download": "Télécharger l'image",
        "card_bgs": {"White": "Blanc", "Light studio": "Studio clair", "Soft grey": "Gris doux", "Warm beige": "Beige chaud", "Gradient blue": "Dégradé bleu"},
    ...
    "de": {
        ...
        "mode_label": "Was möchten Sie erstellen?",
        "mode_text": "Produktbeschreibung",
        "mode_card": "Produktfoto-Karte",
        "card_header": "Produktfoto-Karte",
        "card_hint": "Laden Sie ein Produktfoto hoch — wir entfernen den Hintergrund und stellen das Produkt auf einen sauberen, marktplatzfertigen Hintergrund. Das Produkt selbst wird nicht verändert.",
        "card_upload": "Produktfoto hochladen",
        "card_bg": "Hintergrund",
        "card_generate": "Foto-Karte erstellen",
        "card_need": "Laden Sie zuerst ein Produktfoto hoch.",
        "card_spinner": "Hintergrund wird entfernt und Ihre Karte erstellt...",
        "card_done": "Ihre Karte ist fertig — unten herunterladen.",
        "card_download": "Bild herunterladen",
        "card_bgs": {"White": "Weiß", "Light studio": "Helles Studio", "Soft grey": "Sanftes Grau", "Warm beige": "Warmes Beige", "Gradient blue": "Blauer Verlauf"},
    ...
    "it": {
        ...
        "mode_label": "Cosa vuoi creare?",
        "mode_text": "Descrizione prodotto",
        "mode_card": "Scheda foto prodotto",
        "card_header": "Scheda foto prodotto",
        "card_hint": "Carica una foto del prodotto — rimuoviamo lo sfondo e mettiamo il prodotto su uno sfondo pulito, pronto per i marketplace. Il prodotto non viene alterato.",
        "card_upload": "Carica una foto del prodotto",
        "card_bg": "Sfondo",
        "card_generate": "Crea scheda foto",
        "card_need": "Prima carica una foto del prodotto.",
        "card_spinner": "Rimozione dello sfondo e creazione della scheda...",
        "card_done": "La tua scheda è pronta — scaricala qui sotto.",
        "card_download": "Scarica immagine",
        "card_bgs": {"White": "Bianco", "Light studio": "Studio chiaro", "Soft grey": "Grigio tenue", "Warm beige": "Beige caldo", "Gradient blue": "Blu sfumato"},
    ...
    "pt": {
        ...
        "mode_label": "O que você quer criar?",
        "mode_text": "Descrição do produto",
        "mode_card": "Card de foto do produto",
        "card_header": "Card de foto do produto",
        "card_hint": "Envie uma foto do produto — removemos o fundo e colocamos o produto em um fundo limpo, pronto para marketplace. O produto em si não é alterado.",
        "card_upload": "Envie uma foto do produto",
        "card_bg": "Fundo",
        "card_generate": "Criar card de foto",
        "card_need": "Primeiro envie uma foto do produto.",
        "card_spinner": "Removendo o fundo e montando seu card...",
        "card_done": "Seu card está pronto — baixe abaixo.",
        "card_download": "Baixar imagem",
        "card_bgs": {"White": "Branco", "Light studio": "Estúdio claro", "Soft grey": "Cinza suave", "Warm beige": "Bege quente", "Gradient blue": "Azul degradê"},
...
def render_image_card_tool(t):
    ...
    bg_kind = st.selectbox(t.get("card_bg", "Background"), CARD_BACKGROUNDS, key="card_bg_sel",
                           format_func=lambda k: t.get("card_bgs", {}).get(k, k))
